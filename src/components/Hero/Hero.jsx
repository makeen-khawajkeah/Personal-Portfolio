...
const Hero = ({id}) => {
return (
    <div className="hero min-h-[100vh] relative  section border-b-2 border-black dark:border-white border-dashed " id={id}>
        <img src="/image/hero-lines.png" alt="" className="absolute top-[220px]  w-full md:block hidden h-[400px]  "/>
        <div className="container m-auto " >
            <div className="hero-content relative pt-[140px] md:pt-[240px] flex justify-around flex-col md:flex-row md:gap-0 gap-10 overflow-hidden ">

...
return (
    <div className="hero h-screen relative section border-b-2 border-black dark:border-white border-dashed" id={id}>
        <img src="/src/assets/image/Hero Lines.png" alt="" className="absolute top-[220px]  w-full md:block hidden h-[458px]"/>
            ...
            <div className="hero-content relative top-[140px] md:top-[240px] flex justify-around flex-col md:flex-row md:gap-0 gap-10 ">
                ...
                <div className="right-side relative md:top-0 top-16 ">
                    <div className="images relative">
                        <img src="/src/assets/image/image (4).png" alt="" className="w-[380px]  relative z-10 left-2/4 translate-x-[-50%] -top-[45px] sm:w-[380px] md:w-[380px] lg:w-[430px]"/>
                        <img src="/src/assets/image/Circle.png" alt="" className="absolute top-0 left-2/4 translate-x-[-50%] w-[365px]  md:w-[350px] lg:w-[420px]"/>
                        <img src="/src/assets/image/squers.png" alt="" className="absolute top-0 left-2/4 translate-x-[-50%] w-[365px]  md:w-[350px] lg:w-[420px]" />
                    </div>
                </div>
            </div>
        </div>
